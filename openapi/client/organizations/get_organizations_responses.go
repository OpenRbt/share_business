...
func (o *GetOrganizationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /organizations] getOrganizations", response, response.Code())
	}
}
...
func (o *GetOrganizationsBadRequest) Error() string {
	return fmt.Sprintf("[GET /organizations][%d] getOrganizationsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetOrganizationsBadRequest) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *GetOrganizationsForbidden) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *GetOrganizationsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /organizations][%d] getOrganizationsInternalServerError  %+v", 500, o.Payload)
}
