...
type CreateOrganizationParams struct {
	...
	// Body.
	Body *models.OrganizationCreation
...
func (o *CreateOrganizationParams) WithBody(body *models.OrganizationCreation) *CreateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create organization params
func (o *CreateOrganizationParams) SetBody(body *models.OrganizationCreation) {
	o.Body = body
}
