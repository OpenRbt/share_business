...
// WithServerID adds the serverID to the delete wash server params
func (o *DeleteWashServerParams) WithServerID(serverID string) *DeleteWashServerParams {
	o.SetServerID(serverID)
	return o
}

// SetServerID adds the serverId to the delete wash server params
func (o *DeleteWashServerParams) SetServerID(serverID string) {
	o.ServerID = serverID
}
