...
func (o *DeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /wash-servers/{id}] delete", response, response.Code())
	}
}
...
func (o *DeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /wash-servers/{id}][%d] deleteNoContent ", 204)
}
...
func (o *DeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /wash-servers/{id}][%d] deleteBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteForbidden) Error() string {
	return fmt.Sprintf("[DELETE /wash-servers/{id}][%d] deleteForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /wash-servers/{id}][%d] deleteNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /wash-servers/{id}][%d] deleteInternalServerError  %+v", 500, o.Payload)
}
