...
// ChargeBonusesOnSessionParams contains all the bound params for the charge bonuses on session operation
// typically these are obtained from a http.Request
//
// swagger:parameters chargeBonusesOnSession
...
//
// To ensure default values, the struct must have been initialized with NewChargeBonusesOnSessionParams() beforehand.
func (o *ChargeBonusesOnSessionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
