...
func (m *OrganizationCreation) validateBonusPercentage(formats strfmt.Registry) error {
...
func (m *OrganizationCreation) validateReportsProcessingDelayMinutes(formats strfmt.Registry) error {
...
func (m *OrganizationCreation) validateUtcOffset(formats strfmt.Registry) error {
