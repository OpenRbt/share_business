...
type DeleteWashServerHandlerFunc func(DeleteWashServerParams, *app.AdminAuth) DeleteWashServerResponder

// Handle executing the request and returning a response
func (fn DeleteWashServerHandlerFunc) Handle(params DeleteWashServerParams, principal *app.AdminAuth) DeleteWashServerResponder {
...
type DeleteWashServerHandler interface {
	Handle(DeleteWashServerParams, *app.AdminAuth) DeleteWashServerResponder
}
