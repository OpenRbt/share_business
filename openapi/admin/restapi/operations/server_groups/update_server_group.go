...
type UpdateServerGroupHandlerFunc func(UpdateServerGroupParams, *app.AdminAuth) UpdateServerGroupResponder

// Handle executing the request and returning a response
func (fn UpdateServerGroupHandlerFunc) Handle(params UpdateServerGroupParams, principal *app.AdminAuth) UpdateServerGroupResponder {
...
type UpdateServerGroupHandler interface {
	Handle(UpdateServerGroupParams, *app.AdminAuth) UpdateServerGroupResponder
}
