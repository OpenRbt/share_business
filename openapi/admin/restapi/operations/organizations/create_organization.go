...
type CreateOrganizationHandlerFunc func(CreateOrganizationParams, *app.AdminAuth) CreateOrganizationResponder

// Handle executing the request and returning a response
func (fn CreateOrganizationHandlerFunc) Handle(params CreateOrganizationParams, principal *app.AdminAuth) CreateOrganizationResponder {
...
type CreateOrganizationHandler interface {
	Handle(CreateOrganizationParams, *app.AdminAuth) CreateOrganizationResponder
}
