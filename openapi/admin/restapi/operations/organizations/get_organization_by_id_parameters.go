...
// GetOrganizationByIDParams contains all the bound params for the get organization by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters getOrganizationById
...
//
// To ensure default values, the struct must have been initialized with NewGetOrganizationByIDParams() beforehand.
func (o *GetOrganizationByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetOrganizationByIDParams) bindOrganizationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetOrganizationByIDParams) validateOrganizationID(formats strfmt.Registry) error {
