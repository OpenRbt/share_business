...
type UpdateOrganizationHandlerFunc func(UpdateOrganizationParams, *app.AdminAuth) UpdateOrganizationResponder

// Handle executing the request and returning a response
func (fn UpdateOrganizationHandlerFunc) Handle(params UpdateOrganizationParams, principal *app.AdminAuth) UpdateOrganizationResponder {
...
type UpdateOrganizationHandler interface {
	Handle(UpdateOrganizationParams, *app.AdminAuth) UpdateOrganizationResponder
}
