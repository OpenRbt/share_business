...
func (o *UpdateOrganizationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.OrganizationUpdate
...
func (o *UpdateOrganizationParams) bindOrganizationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateOrganizationParams) validateOrganizationID(formats strfmt.Registry) error {
