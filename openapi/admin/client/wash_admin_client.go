...
import (
	...
	"washbonus/openapi/admin/client/applications"
	"washbonus/openapi/admin/client/organizations"
	"washbonus/openapi/admin/client/server_groups"
	"washbonus/openapi/admin/client/users"
	"washbonus/openapi/admin/client/wash_servers"
)
