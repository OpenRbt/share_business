...
func (o *UpdateOrganizationParams) WithBody(body *models.OrganizationUpdate) *UpdateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update organization params
func (o *UpdateOrganizationParams) SetBody(body *models.OrganizationUpdate) {
	o.Body = body
}
