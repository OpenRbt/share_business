...
type GetServerGroupByIDHandlerFunc func(GetServerGroupByIDParams, *app.Auth) GetServerGroupByIDResponder

// Handle executing the request and returning a response
func (fn GetServerGroupByIDHandlerFunc) Handle(params GetServerGroupByIDParams, principal *app.Auth) GetServerGroupByIDResponder {
...
type GetServerGroupByIDHandler interface {
	Handle(GetServerGroupByIDParams, *app.Auth) GetServerGroupByIDResponder
}
