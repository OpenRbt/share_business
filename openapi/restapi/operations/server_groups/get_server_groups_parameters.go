...
func (o *GetServerGroupsParams) bindIsManagedByMe(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetServerGroupsParams()
		return nil
	}
...
func (o *GetServerGroupsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServerGroupsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetServerGroupsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServerGroupsParams) validateOffset(formats strfmt.Registry) error {
