...
type RemoveUserFromOrganizationHandlerFunc func(RemoveUserFromOrganizationParams, *app.Auth) RemoveUserFromOrganizationResponder

// Handle executing the request and returning a response
func (fn RemoveUserFromOrganizationHandlerFunc) Handle(params RemoveUserFromOrganizationParams, principal *app.Auth) RemoveUserFromOrganizationResponder {
...
type RemoveUserFromOrganizationHandler interface {
	Handle(RemoveUserFromOrganizationParams, *app.Auth) RemoveUserFromOrganizationResponder
}
