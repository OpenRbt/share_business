...
func (o *RemoveUserFromOrganizationURL) Build() (*url.URL, error) {
	...
	if organizationID != "" {
		...
		return nil, errors.New("organizationId is required on RemoveUserFromOrganizationURL")
	}
	...
	if userID != "" {
		...
		return nil, errors.New("userId is required on RemoveUserFromOrganizationURL")
	}
