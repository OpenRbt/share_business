...
type GetOrganizationsHandlerFunc func(GetOrganizationsParams, *app.Auth) GetOrganizationsResponder

// Handle executing the request and returning a response
func (fn GetOrganizationsHandlerFunc) Handle(params GetOrganizationsParams, principal *app.Auth) GetOrganizationsResponder {
...
type GetOrganizationsHandler interface {
	Handle(GetOrganizationsParams, *app.Auth) GetOrganizationsResponder
}
