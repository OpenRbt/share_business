...
type DeleteOrganizationHandlerFunc func(DeleteOrganizationParams, *app.Auth) DeleteOrganizationResponder

// Handle executing the request and returning a response
func (fn DeleteOrganizationHandlerFunc) Handle(params DeleteOrganizationParams, principal *app.Auth) DeleteOrganizationResponder {
...
type DeleteOrganizationHandler interface {
	Handle(DeleteOrganizationParams, *app.Auth) DeleteOrganizationResponder
}
