...
func (o *DeleteOrganizationParams) bindOrganizationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteOrganizationParams) validateOrganizationID(formats strfmt.Registry) error {
