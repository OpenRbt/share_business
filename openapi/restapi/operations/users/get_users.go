...
type GetUsersHandlerFunc func(GetUsersParams, *app.Auth) GetUsersResponder

// Handle executing the request and returning a response
func (fn GetUsersHandlerFunc) Handle(params GetUsersParams, principal *app.Auth) GetUsersResponder {
	return fn(params, principal)
}

// GetUsersHandler interface for that can handle valid get users params
type GetUsersHandler interface {
	Handle(GetUsersParams, *app.Auth) GetUsersResponder
}
