...
// WithBody adds the body to the list user params
func (o *ListUserParams) WithBody(body *models.ListParams) *ListUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list user params
func (o *ListUserParams) SetBody(body *models.ListParams) {
	o.Body = body
}
