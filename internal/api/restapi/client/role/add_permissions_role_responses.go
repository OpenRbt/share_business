...
// IsSuccess returns true when this add permissions role o k response has a 2xx status code
func (o *AddPermissionsRoleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this add permissions role o k response has a 3xx status code
func (o *AddPermissionsRoleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this add permissions role o k response has a 4xx status code
func (o *AddPermissionsRoleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this add permissions role o k response has a 5xx status code
func (o *AddPermissionsRoleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this add permissions role o k response a status code equal to that given
func (o *AddPermissionsRoleOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *AddPermissionsRoleOK) String() string {
	return fmt.Sprintf("[POST /role/addPermissions][%d] addPermissionsRoleOK ", 200)
}
...
// IsSuccess returns true when this add permissions role default response has a 2xx status code
func (o *AddPermissionsRoleDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this add permissions role default response has a 3xx status code
func (o *AddPermissionsRoleDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this add permissions role default response has a 4xx status code
func (o *AddPermissionsRoleDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this add permissions role default response has a 5xx status code
func (o *AddPermissionsRoleDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this add permissions role default response a status code equal to that given
func (o *AddPermissionsRoleDefault) IsCode(code int) bool {
...
func (o *AddPermissionsRoleDefault) String() string {
	return fmt.Sprintf("[POST /role/addPermissions][%d] addPermissionsRole default  %+v", o._statusCode, o.Payload)
}
