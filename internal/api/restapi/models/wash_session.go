...
// WashSession washSession object
//
// swagger:model washSession
...
// Validate validates this wash session
func (m *WashSession) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WashSession) validateClosingAt(formats strfmt.Registry) error {
...
func (m *WashSession) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *WashSession) validateExpirationAt(formats strfmt.Registry) error {
...
func (m *WashSession) validateUpdateAt(formats strfmt.Registry) error {
...
func (m *WashSession) validateUser(formats strfmt.Registry) error {
...
func (m *WashSession) validateWashServer(formats strfmt.Registry) error {
...
// ContextValidate validate this wash session based on the context it is used
func (m *WashSession) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WashSession) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WashSession) contextValidateWashServer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WashSession) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WashSession) UnmarshalBinary(b []byte) error {
	var res WashSession
