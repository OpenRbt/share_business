...
type ListWashServerOK struct {
	Payload *models2.ListWashServer
}
...
func (o *ListWashServerOK) GetPayload() *models2.ListWashServer {
	return o.Payload
}
...
func (o *ListWashServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.ListWashServer)
...
func (o *ListWashServerDefault) GetPayload() *models2.Error {
	return o.Payload
}
