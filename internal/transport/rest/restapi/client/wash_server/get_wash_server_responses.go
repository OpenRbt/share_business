...
func (o *GetWashServerOK) GetPayload() *models2.WashServer {
	return o.Payload
}
...
func (o *GetWashServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.WashServer)
...
func (o *GetWashServerDefault) GetPayload() *models2.Error {
	return o.Payload
}
