...
func (o *GetBalanceOK) WithPayload(payload *models2.Balance) *GetBalanceOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get balance o k response
func (o *GetBalanceOK) SetPayload(payload *models2.Balance) {
	o.Payload = payload
}
...
func (o *GetBalanceDefault) WithPayload(payload *models2.Error) *GetBalanceDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get balance default response
func (o *GetBalanceDefault) SetPayload(payload *models2.Error) {
	o.Payload = payload
}
