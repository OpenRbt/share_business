...
type AddBalanceCreated struct {
	...
	/*
	  In: Body
	*/
	Payload *models2.Balance `json:"body,omitempty"`
}
...
func (o *AddBalanceCreated) WithPayload(payload *models2.Balance) *AddBalanceCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add balance created response
func (o *AddBalanceCreated) SetPayload(payload *models2.Balance) {
	o.Payload = payload
}
...
func (o *AddBalanceDefault) WithPayload(payload *models2.Error) *AddBalanceDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add balance default response
func (o *AddBalanceDefault) SetPayload(payload *models2.Error) {
	o.Payload = payload
}
