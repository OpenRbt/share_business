...
type GetWashServerOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models2.WashServer `json:"body,omitempty"`
}
...
func (o *GetWashServerOK) WithPayload(payload *models2.WashServer) *GetWashServerOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get wash server o k response
func (o *GetWashServerOK) SetPayload(payload *models2.WashServer) {
	o.Payload = payload
}
...
func (o *GetWashServerDefault) WithPayload(payload *models2.Error) *GetWashServerDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get wash server default response
func (o *GetWashServerDefault) SetPayload(payload *models2.Error) {
	o.Payload = payload
}
