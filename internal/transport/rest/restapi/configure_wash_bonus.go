...
import (
	...
	"wash-bonus/internal/transport/rest/restapi/operations/balance"
	"wash-bonus/internal/transport/rest/restapi/operations/standard"
	"wash-bonus/internal/transport/rest/restapi/operations/user"
	"wash-bonus/internal/transport/rest/restapi/operations/wash_server"
)

//go:generate swagger generate server --target ../../rest --name WashBonus --spec ../../../../swagger.yaml --principal interface{} --exclude-main
