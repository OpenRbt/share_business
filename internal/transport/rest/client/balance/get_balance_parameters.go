...
// WithBody adds the body to the get balance params
func (o *GetBalanceParams) WithBody(body GetBalanceBody) *GetBalanceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get balance params
func (o *GetBalanceParams) SetBody(body GetBalanceBody) {
	o.Body = body
}
