...
type GetProfileHandlerFunc func(GetProfileParams, *app.Auth) GetProfileResponder

// Handle executing the request and returning a response
func (fn GetProfileHandlerFunc) Handle(params GetProfileParams, principal *app.Auth) GetProfileResponder {
	return fn(params, principal)
}

// GetProfileHandler interface for that can handle valid get profile params
type GetProfileHandler interface {
	Handle(GetProfileParams, *app.Auth) GetProfileResponder
}
...
/*
	GetProfile swagger:route GET /profile user getProfile
