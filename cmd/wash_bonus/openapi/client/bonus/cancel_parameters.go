...
type CancelParams struct {
	...
	// Body.
	Body *models.BonusConsumeCancel
...
func (o *CancelParams) WithBody(body *models.BonusConsumeCancel) *CancelParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel params
func (o *CancelParams) SetBody(body *models.BonusConsumeCancel) {
	o.Body = body
}
