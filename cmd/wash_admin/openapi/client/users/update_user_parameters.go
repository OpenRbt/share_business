...
// WithUpdate adds the update to the update user params
func (o *UpdateUserParams) WithUpdate(update *models.UserUpdate) *UpdateUserParams {
	o.SetUpdate(update)
	return o
}

// SetUpdate adds the update to the update user params
func (o *UpdateUserParams) SetUpdate(update *models.UserUpdate) {
	o.Update = update
}
